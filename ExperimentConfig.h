...
struct ExperimentConfig {
  struct Output { std::string output_dir="results/default"; std::string summary_report="summary.rpt"; std::string net_info="net_info.txt"; std::string plot_data_dir="plot_data"; std::string plot_dir="plots"; bool enable_plot_generation=true; } output;
